...
* Tracing - Events und Subevents in kausaler Ordnung aufzeichen
...
* Trends erkennbar
* z.B: "Wie oft tritt genau der Fehler xy auf"

**->** "Alarm schlagen" bei gewisser Überschreitung
...
* Bietet verschiedenste Metriken
** Gauges
** Counters
** Timers
